...
-- Clipboard (scheduled after UiEnter)
...
require('lazy').setup({
  ...
  'jeetsukumaran/vim-indentwise', -- navigate between indent levels
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    opts = {
      ...
      spec = {
        ...
        { 'grn', group = '[R]e[n]ame' },
        { 'gra', group = '[G]oto Code [A]ction', mode = { 'n', 'x' } },
        { 'grr', group = '[G]oto [R]eferences' },
        { 'gri', group = '[G]oto [I]mplementation' },
        { 'gO', group = 'Open Document Symbols' },
        { 'grt', group = '[G]oto [T]ype Definition' },
      },
    },
  },
